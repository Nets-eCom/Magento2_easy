!function () {
        ...
        t.Checkout = class {
            constructor(e) {
                this.iFrameDibsContainerId = "dibs-checkout-content", this.iFrameDefaultContainerId = "nets-checkout-content", this.iFrameContentStyleClass = "dibs-checkout-wrapper", this.iFrameId = "nets-checkout-iframe", this.applePayJSId = "applepayjs", this.endPointDomain = void 0, this.iFrameSrc = void 0, this.styleSheetSrc = void 0, this.paymentFailed = !1, this.isApplePayEnabled = !1, this.applePaySession = void 0, this.applePayPaymentRequest = void 0, this.allowedShippingCountries = void 0, this.featureToggles = void 0, this.onPaymentCompletedEvent = void 0, this.onPaymentCancelledEvent = void 0, this.onPayInitializedEvent = void 0, this.onAddressChangedEvent = void 0, this.onApplepayContactUpdatedEvent = void 0, this.checkoutInitialized = !1, this.isThemeSetExplicitly = !1, this.options = void 0, this.setupMessageListeners = e => {
                    ...
                    switch (this.consoleDebug(`Event received: ${t.eventType}, ${JSON.stringify(t.data)}`), t.eventType) {
                        case"featureTogglesChanged":
                            this.featureToggles = t.data;
                            break;
                        case"checkoutInitialized":
                            this.checkoutInitialized || (this.checkoutInitialized = !0, this.consoleLog("checkoutInitialized"), this.publishUnsentMessagesToCheckout(), this.postThemeToCheckout(), this.sendIframeSizing());
                            break;
                        case"goto3DS":
                            this.goto3DS(t.data);
                            break;
                        case"payInitialized":
                            this.onPayInitializedEvent ? this.onPayInitializedEvent(t.data) : (this.consoleLog("PaymentInitialized not handled by merchant"), this.sendPaymentOrderFinalizedEvent(!0));
                            break;
                        case"paymentSuccess":
                    ...
                    this.postMessage(e)
                }, this.unsentMessages = [], this.options = e, this.init()
            }

            on(e, t) {
                if (!t) throw new Error(`No function was supplied in the second argument. Please supply the function you want to be called on the ${e} event`);
                if ("pay-initialized" === e) this.onPayInitializedEvent = t; else if ("payment-completed" === e) this.onPaymentCompletedEvent = t; else if ("payment-cancelled" === e) this.onPaymentCancelledEvent = t; else if ("address-changed" === e) this.onAddressChangedEvent = t; else if ("applepay-contact-updated" === e) this.onApplepayContactUpdatedEvent = t; else {
                    const t = e;
            ...
            send(e, t) {
                ...
                } else "payment-cancel-initiated" === e && this.postMessage(new s("cancelPayment"))
            }
            ...
            setTheme(e) {
                this.isThemeSetExplicitly = !0, this.postMessage(new s("setTheme", e))
            }
            ...
            completeApplePayShippingContactUpdate(e) {
                if (this.isApplePayEnabled && this.applePaySession && this.applePayPaymentRequest) try {
                    ...
                    if (!e) {
                        ...
                        return void this.applePaySession.completeShippingContactSelection({newTotal: t, errors: [e]})
                    }
                    ...
                    "number" == typeof e && (e = String(e)), this.consoleLog(`Apple pay order amount update with ${e}`);
                    const n = new s("updateApplePayOrderAmount", e);
                    this.postMessage(n);
                    const {label: i, type: o} = this.applePayPaymentRequest.total, a = Number(e) / 100;
                ...
                } else this.consoleLog("Does not support this operation. ApplePay is disabled.")
            }
            ...
            init() {
                ...
                const r = null == (e = this.options) ? void 0 : e.checkoutKey,
                    p = null == (t = this.options) ? void 0 : t.paymentId, l = this;
                if (this.options.containerId || (this.options.containerId = document.getElementById(this.iFrameDefaultContainerId) ? this.iFrameDefaultContainerId : this.iFrameDibsContainerId), !this.isThemeSet() && i && r && p) {
                    const e = new XMLHttpRequest;
                    e.addEventListener("load", (function () {
                        if (200 === this.status && !l.isThemeSetExplicitly) {
                            const e = JSON.parse(this.responseText);
                            l.options.theme = e, l.postThemeToCheckout()
                        }
                    })), e.open("GET", `${i}/api/v1/theming/checkout`), e.setRequestHeader("CheckoutKey", r), e.setRequestHeader("PaymentId", p), e.send()
                }
                this.paymentFailed = "true" === this.getQueryStringParameter("paymentFailed", window.location.href), this.endPointDomain = "https://test.checkout.dibspayment.eu", this.iFrameSrc = `${this.endPointDomain}/v1/?checkoutKey=${null == (n = this.options) ? void 0 : n.checkoutKey}&paymentId=${null == (s = this.options) ? void 0 : s.paymentId}`, null != (o = this.options) && o.partnerMerchantNumber && (this.iFrameSrc += `&partnerMerchantNumber=${this.options.partnerMerchantNumber}`), null != (a = this.options) && a.language && (this.iFrameSrc += `&language=${this.options.language}`), this.paymentFailed && (this.iFrameSrc += `&paymentFailed=${this.paymentFailed}`), this.styleSheetSrc = `${this.endPointDomain}/v1/assets/css/checkout.css`, this.setListeners();
                const h = document.getElementsByTagName("head")[0];
                this.addStyleSheet(h), this.addMainIFrame()
            }

            isWindowOnTopLevel() {
                try {
                    return window.top.location.href, !0
                } catch (e) {
                    return !1
                }
            }
            ...
            inceptionIframeInitialized() {
                if (this.isWindowOnTopLevel()) {
                    var e;
                    const t = this.getIFrameHeight(), n = null == (e = window.top) ? void 0 : e.innerHeight;
                    if (n && t > n) {
                        this.resizeIFrame(n);
            ...
            getErrorMsg(e, t) {
                let n = t;
                return "string" == typeof e ? n = `${t} ${e}` : e instanceof Error && (n = `${t} ${e.message}`), n
            }

            loadApplePayJs(e) {
                const t = document.getElementById(this.applePayJSId);
                if (!t) {
                    const t = document.createElement("script");
                    t.src = "https://applepay.cdn-apple.com/jsapi/v1/apple-pay-sdk.js", t.id = this.applePayJSId, t.defer = !0, t.onload = () => {
                        this.consoleLog("Loaded applepay js script"), e()
                    }, t.onerror = () => {
            ...
            getIsApplePaySupportedOnCurrentDevice() {
                this.loadApplePayJs((() => {
                    try {
                        ...
                        if (e) {
                            const t = e.supportsVersion(o), n = e && e.canMakePayments();
                            t || this.consoleLog("Does not support applepay version : " + o, !0), n || this.consoleLog("Cannot make Apple payments", !0), this.isApplePayEnabled = e && n && t;
                            const i = new s("setIsApplePaySupportedOnCurrentDevice", this.isApplePayEnabled);
                            this.consoleLog("Apple pay enabled : " + this.isApplePayEnabled), this.postMessage(i)
                        } else {
            ...
            applePayClicked(e) {
                try {
                    this.applePayPaymentRequest = e, this.applePaySession = new window.ApplePaySession(o, e), this.applePaySession.onvalidatemerchant = this.getOnValidateMerchant(), this.applePaySession.onpaymentauthorized = this.getOnPaymentAuthorized(), this.applePaySession.oncancel = this.getOnCancel(), this.applePaySession.onshippingcontactselected = this.getOnShippingContactSelected(), this.applePaySession.begin()
                } catch (e) {
            ...
            getOnCancel() {
                return t => {
                    ...
                    this.postMessage(n), this.isFeatureToggleEnabled(e.ApplePayOnCancelDontAbort) ? this.consoleLog("Apple pay cancelled.") : this.abortApplePay()
                }
            }
            ...
            getOnShippingContactSelected() {
                return e => {
                    ...
                    if (!i) {
                        ...
                        return e.message = "Country is missing in shipping address", void this.applePaySession.completeShippingContactSelection({
                            newTotal: s,
                            errors: [e]
                        })
                    }
                    if ((null == (n = this.allowedShippingCountries) ? void 0 : n.length) > 0 && !this.allowedShippingCountries.includes(i)) {
                        const e = new ApplePayError("addressUnserviceable", "country");
                        return e.message = "Country specified in shipping address is not supported", void this.applePaySession.completeShippingContactSelection({
                            newTotal: s,
                            errors: [e]
                        })
                    }
                    if (this.onApplepayContactUpdatedEvent) return void this.onApplepayContactUpdatedEvent({
                        postalCode: e.shippingContact.postalCode,
                        countryCode: e.shippingContact.countryCode
                    });
                    const o = new ApplePayError("unknown", void 0);
                    o.message = "Applepay contact update handler missing.", this.applePaySession.completeShippingContactSelection({
                        newTotal: s,
                        errors: [o]
                    })
                }
            ...
            getOnPaymentAuthorized() {
                return e => {
                    var t, n, i, o;
                    if ((e => null == e || 0 === e.length || "{}" === JSON.stringify(e))(null == e || null == (t = e.payment) ? void 0 : t.token)) return this.consoleLog(`Apple Pay ${"object" == typeof (null == e ? void 0 : e.payment) && 0 === Object.keys(null == e ? void 0 : e.payment).length ? "payment" : "token"} is missing`, !0), void this.applePaySession.completePayment({
                        status: ApplePaySession.STATUS_FAILURE,
                        errors: [new ApplePayError("unknown", void 0, "Payment data is empty")]
                    });
                    if (null != (n = e.payment.shippingContact) && n.countryCode && (null == (i = this.allowedShippingCountries) ? void 0 : i.length) > 0 && !this.allowedShippingCountries.includes(null == (o = e.payment.shippingContact) ? void 0 : o.countryCode)) return this.consoleLog("Country specified in shipping address is not supported", !0), void this.applePaySession.completePayment({
                        status: ApplePaySession.STATUS_FAILURE,
            ...
            onReceivedMerchantSession(e) {
                try {
                    ...
                    this.consoleError(e, "Something went wrong while validating merchant session"), this.abortApplePay()
                }
            }

            onApplePayPaymentComplete(e) {
                try {
                    const t = {status: Boolean(e).valueOf() ? ApplePaySession.STATUS_SUCCESS : ApplePaySession.STATUS_FAILURE};
                    this.applePaySession.completePayment(t)
                } catch (e) {
                    this.consoleError(e, "Something went wrong while completing AppleyPay payment."), this.abortApplePay()
                }
            }
            ...
            addStyleSheet(e) {
                ...
                t.rel = "stylesheet", t.type = "text/css", t.href = this.styleSheetSrc, e.appendChild(t), this.consoleLog("Added stylesheet script " + t.href)
            }

            addMainIFrame() {
                const e = document.createElement("iframe");
                e.id = this.iFrameId, e.src = this.iFrameSrc, e.referrerPolicy = "strict-origin-when-cross-origin", e.allow = "payment *";
                const t = document.getElementById(this.options.containerId);
                null !== t && (t.setAttribute("class", this.iFrameContentStyleClass), t.appendChild(e), this.consoleLog("Added main IFrame script to " + this.options.containerId)), e.onload = () => {
                    this.consoleLog("iframe ready")
                }, e.allowTransparency = "true", e.frameBorder = "0", e.scrolling = "no"
            }
            ...
            goto3DS(e) {
                ...
                n.style.display = "none", n.innerHTML = t.form, document.body.appendChild(n);
            ...
            getIFrameSize() {
                const e = this.getIframe(), {offsetWidth: t, offsetHeight: n} = e;
            ...
            removeListeners() {
                window.removeEventListener("message", this.setupMessageListeners), window.removeEventListener("resize", this.setupResizeListeners)
            }

            setListeners() {
                window.addEventListener("message", this.setupMessageListeners, !1), window.addEventListener("resize", this.setupResizeListeners)
            }

            removePaymentFailedQueryParameter() {
                const e = new URLSearchParams(window.location.search), t = "paymentFailed";
                if (e.has(t)) {
                    e.delete(t);
                    const n = e.toString(), s = `${location.origin}${location.pathname}?${n}`;
            ...
            checkMsgSafe(e) {
                const t = e.origin;
                return void 0 === t ? (this.consoleDebug(`Checkout: unknown origin ${JSON.stringify(t)} (${JSON.stringify(e)}, ${JSON.stringify(e.data)})`), !1) : !(e.data && "react-devtools-bridge" === e.data.source || t !== this.endPointDomain && (this.consoleDebug(`Checkout: unknown origin ${JSON.stringify(t)} (${JSON.stringify(e)}, ${JSON.stringify(e.data)})`), 1))
            }

            getQueryStringParameter(e, t) {
                if (t = t || "", 0 === (e = e || "").length || 0 === t.length) return "";
            ...
            consoleError(e, t) {
                const {name: i, stack: o} = e, a = this.getErrorMsg(e, t);
                this.postMessage(new s("logErrorMessage", {name: i, message: a, stack: o})), n && console.error(a)
            }
    ...
    }(a || (a = {})), r || (r = {}), a.Checkout, window.Dibs = a
}();
