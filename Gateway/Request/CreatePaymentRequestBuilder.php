...
use Nexi\Checkout\Gateway\Request\NexiCheckout\MethodConfigurationBuilder;
...
class CreatePaymentRequestBuilder implements BuilderInterface
{
     ...
     * @param MethodConfigurationBuilder $methodConfigurationBuilder
     */
    ...
    private function buildPayment(Order|Quote $order): Payment
    {
        return new Payment(
            ...
            paymentMethodsConfiguration: $this->methodConfigurationBuilder->buildPaymentMethodsConfiguration(
                $order
            ),
        );
    }
    ...
    private function buildConsumer(Order|Quote $salesObject): Consumer
    {
        ...
        return new Consumer(
            ...
            billingAddress: new Address(
                ...
                postalCode: str_replace(' ', '', $billingAddress->getPostcode()),
